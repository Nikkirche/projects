...
{	
	{"", "0", "0"},
        ...
        {"", "-80000000000000000000000000000000", "170141183460469231731687303715884105728"}, //strange test
        {"", "-0x80000000000000000000000000000000", "170141183460469231731687303715884105728"}, //strange test
...
int main(void)
{
	...
	printf("was %i, passed %i",all, passed);
  	return all - passed;
}